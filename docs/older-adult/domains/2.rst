...
.. admonition:: PRACTICE POINT - elder abuse
   ...
   The World Health Organisation defines elder abuse as 'a single, or repeated act, or lack of appropriate action, occurring within any relationship where there is an expectation of trust which causes harm or distress to an older person.' Elder abuse includes financial, physical, psychological, emotional, and sexual abuse or neglect. Users of the IAR Guidance and IAR-DST for older adults must understand and be aware of elder abuse, and what to do if an older adult discloses elder abuse (or if elder abuse is suspected). `More information about elder abuse <https://humanrights.gov.au/elderabuse>`_ is available through the `Australian Human Rights Commission <https://humanrights.gov.au>`_.

...
* Unless otherwise stated, IAR users should consider what has been ‘typical’ for the person over the past 30 days except where the person has experienced more recent or sudden changes or deterioration. Where this is the case, users should base their ratings on the more recent changes.
...
* Use all available information in making a rating. This should include clinical interviews and information gathered from the child, the child's family, referrers, or other informants where possible. Consider all reliable perspectives when selecting a rating (e.g., including information provided by the child, family, or referrer).
